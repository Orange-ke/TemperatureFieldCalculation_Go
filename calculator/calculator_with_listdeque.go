...
//)
//
//type calculatorWithListDeque struct {
//	// 计算参数
//	edgeWidth int
//
...
//
//	Field         *deque.ListDeque
//	thermalField  *deque.ListDeque // 温度场容器
//	thermalField1 *deque.ListDeque
//
//	// 每计算一个 ▲t 进行一次异或运算
//	alternating bool
//
...
//}
//
//func NewCalculatorWithListDeque(edgeWidth int) *calculatorWithListDeque {
//	calculatorWithListDeque := &calculatorWithListDeque{}
//	if edgeWidth < 0 {
//		edgeWidth = 0
//	}
//	if edgeWidth > 20 {
...
//
//	start := time.Now()
//	calculatorWithListDeque.initialTemperature = 1550.0
//	calculatorWithListDeque.thermalField = deque.NewListDeque(ZLength / ZStep)
//	calculatorWithListDeque.thermalField1 = deque.NewListDeque(ZLength / ZStep)
//
//	calculatorWithListDeque.Field = calculatorWithListDeque.thermalField
//
//	calculatorWithListDeque.v = int64(10 * 1.5 * 1000 / 60) // m / min
//	calculatorWithListDeque.alternating = true
//	calculatorWithListDeque.calcHub = NewCalcHub()
//
//	calculatorWithListDeque.edgeWidth = edgeWidth
//	calculatorWithListDeque.step = 1
//	if calculatorWithListDeque.edgeWidth > 0 {
//		calculatorWithListDeque.step = 2
//	}
//
//	initParameters()
//
//	fmt.Println("初始化时间: ", time.Since(start))
//	return calculatorWithListDeque
//}
//
//func (c *calculatorWithListDeque) GetCalcHub() *CalcHub {
//	return c.calcHub
//}
//
//// 计算所有切片中最短的时间步长
//func (c *calculatorWithListDeque) calculateTimeStep() (float32, time.Duration) {
//	start := time.Now()
//	min := float32(1000.0)
//	var t float32
...
//}
//
//func (c *calculatorWithListDeque) Run() {
//	// 先计算timeStep
...
//}
//
//func (c *calculatorWithListDeque) updateSliceInfo(calcDuration time.Duration) {
//	v := c.v // m/min -> mm/s
//	var distance int64
...
//
//// 并行计算方法1
//func (c *calculatorWithListDeque) calculateConcurrently(deltaT float32) time.Duration {
//	var start = time.Now()
...
//}
//
//func (c *calculatorWithListDeque) BuildData() *TemperatureData {
//	upSides := &UpSides{
//		Up:    &upUp,
//		Left:  &upLeft,
//		Right: &upRight,
...
//}
//
//func (c *calculatorWithListDeque) calculateCase2(deltaT float32) {
//	//var start = time.Now()
//	var count = 0
//	c.Field.Traverse(func(z int, item *model.ItemType) {
//		// 先计算点，再计算外表面，再计算里面的点
...
//}
//
//func (c *calculatorWithListDeque) calculateCase3(deltaT float32) {
//	//var start = time.Now()
//	var count = 0
//	c.Field.Traverse(func(z int, item *model.ItemType) {
//		// 先计算点，再计算外表面，再计算里面的点
...
//}
//
//func (c *calculatorWithListDeque) calculateCase4(deltaT float32) {
//	//var start = time.Now()
//	var count = 0
//	c.Field.Traverse(func(z int, item *model.ItemType) {
//		// 先计算点，再计算外表面，再计算里面的点
...
//
//// 计算一个left top点的温度变化
//func (c *calculatorWithListDeque) calculatePointLT(deltaT float32, z int, slice *model.ItemType) {
...
//
//// 计算上表面点温度变化
//func (c *calculatorWithListDeque) calculatePointTA(deltaT float32, x, z int, slice *model.ItemType) {
...
//
//// 计算right top点的温度变化
//func (c *calculatorWithListDeque) calculatePointRT(deltaT float32, z int, slice *model.ItemType) {
...
//
//// 计算右表面点的温度变化
//func (c *calculatorWithListDeque) calculatePointRA(deltaT float32, y, z int, slice *model.ItemType) {
...
//func (c *calculatorWithListDeque) calculatePointRB(deltaT float32, z int, slice *model.ItemType) {
...
//
//// 计算下表面点的温度变化
//func (c *calculatorWithListDeque) calculatePointBA(deltaT float32, x, z int, slice *model.ItemType) {
...
//
//// 计算left bottom点的温度变化
//func (c *calculatorWithListDeque) calculatePointLB(deltaT float32, z int, slice *model.ItemType) {
...
//
//// 计算左表面点温度的变化
//func (c *calculatorWithListDeque) calculatePointLA(deltaT float32, y, z int, slice *model.ItemType) {
...
//
//// 计算内部点的温度变化
//func (c *calculatorWithListDeque) calculatePointIN(deltaT float32, x, y, z int, slice *model.ItemType) {
...
//}
//
//func (c *calculatorWithListDeque) Calculate() {
//	for z := 0; z < 4000; z++ {
//		c.thermalField.AddFirst(c.initialTemperature)
//		c.thermalField1.AddFirst(c.initialTemperature)
//	}
